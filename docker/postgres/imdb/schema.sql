...
--
-- Name: aka_name aka_name_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.aka_name
    ADD CONSTRAINT aka_name_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.name(id);


--
-- Name: aka_title aka_title_episode_of_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.aka_title
    ADD CONSTRAINT aka_title_episode_of_id_fkey FOREIGN KEY (episode_of_id) REFERENCES public.aka_title(id);


--
-- Name: aka_title aka_title_kind_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.aka_title
    ADD CONSTRAINT aka_title_kind_id_fkey FOREIGN KEY (kind_id) REFERENCES public.kind_type(id);


--
-- Name: aka_title aka_title_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.aka_title
    ADD CONSTRAINT aka_title_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.title(id);


--
-- Name: cast_info cast_info_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cast_info
    ADD CONSTRAINT cast_info_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.title(id);


--
-- Name: cast_info cast_info_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cast_info
    ADD CONSTRAINT cast_info_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.name(id);


--
-- Name: cast_info cast_info_person_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cast_info
    ADD CONSTRAINT cast_info_person_role_id_fkey FOREIGN KEY (person_role_id) REFERENCES public.char_name(id);


--
-- Name: cast_info cast_info_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cast_info
    ADD CONSTRAINT cast_info_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.role_type(id);


--
-- Name: complete_cast complete_cast_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.complete_cast
    ADD CONSTRAINT complete_cast_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.title(id);


--
-- Name: complete_cast complete_cast_status_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.complete_cast
    ADD CONSTRAINT complete_cast_status_id_fkey FOREIGN KEY (status_id) REFERENCES public.comp_cast_type(id);


--
-- Name: complete_cast complete_cast_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.complete_cast
    ADD CONSTRAINT complete_cast_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.comp_cast_type(id);


--
-- Name: movie_companies movie_companies_company_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_companies
    ADD CONSTRAINT movie_companies_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.company_name(id);


--
-- Name: movie_companies movie_companies_company_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_companies
    ADD CONSTRAINT movie_companies_company_type_id_fkey FOREIGN KEY (company_type_id) REFERENCES public.company_type(id);


--
-- Name: movie_companies movie_companies_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_companies
    ADD CONSTRAINT movie_companies_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.title(id);


--
-- Name: movie_info movie_info_info_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_info
    ADD CONSTRAINT movie_info_info_type_id_fkey FOREIGN KEY (info_type_id) REFERENCES public.info_type(id);


--
-- Name: movie_info movie_info_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_info
    ADD CONSTRAINT movie_info_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.title(id);


--
-- Name: movie_keyword movie_keyword_keyword_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_keyword
    ADD CONSTRAINT movie_keyword_keyword_id_fkey FOREIGN KEY (keyword_id) REFERENCES public.keyword(id);


--
-- Name: movie_keyword movie_keyword_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_keyword
    ADD CONSTRAINT movie_keyword_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.title(id);


--
-- Name: movie_link movie_link_link_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_link
    ADD CONSTRAINT movie_link_link_type_id_fkey FOREIGN KEY (link_type_id) REFERENCES public.link_type(id);


--
-- Name: movie_link movie_link_linked_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_link
    ADD CONSTRAINT movie_link_linked_movie_id_fkey FOREIGN KEY (linked_movie_id) REFERENCES public.title(id);


--
-- Name: movie_link movie_link_movie_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.movie_link
    ADD CONSTRAINT movie_link_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.title(id);


--
-- Name: person_info person_info_info_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.person_info
    ADD CONSTRAINT person_info_info_type_id_fkey FOREIGN KEY (info_type_id) REFERENCES public.info_type(id);


--
-- Name: person_info person_info_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.person_info
    ADD CONSTRAINT person_info_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.name(id);

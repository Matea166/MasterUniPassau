...
# Remove timestamp pattern, for example _20260627_164536
...
# 4. Normalize numbers, for example 2.0 -> 2
key = key.replace(".0", "")
...
"""
Add vertical labels above bars.

For grouped bars with error bars, yerr is used so the label is placed
above the black error bar instead of overlapping it.
"""
...
# Extra vertical space so rotated labels above error bars are not cut off.
